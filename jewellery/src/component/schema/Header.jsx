    ...
    <div>
      <Box sx={{ display: "flex", background: "red" }}>
        <AppBar position="fixed">
          <Toolbar style={{ background: "#01579b", minHeight: "45px" }}>
            ...
            <Box sx={{ display: { xs: "none", md: "flex" } }}>
              <ClickAwayListener onClickAway={handleClosePopper}>
                <div style={{ display: "flex", alignItems: "center", cursor: "pointer" }}>
                  ...
                  <div style={{ flex: 1 }}>
                    <span style={{ display: "block", fontWeight: "bold", fontSize: "12px", color: "#FFFFFF" }}>
                      {userData.username}
                    </span>
                    <span style={{ display: "block", fontSize: "11px", color: "#f1c40f" }}>
                      {userData.role}
                    </span>
                  </div>
